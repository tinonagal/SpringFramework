...
public class DemoTest {
	...
	public static void main(String[] args) {
		...
		String result;
		do {
			System.out.println("1: Add Employee 2: Delete Employee 3: Update Employee 4: Retrieve All Employee 5: Retrieve All Employee By Salary 6: Retrieve All Employee as List 7: Retrieve All Employee as List By Salary");
			...
			case 6: List<Employee> listOfEmployees = es.findAllEmployeeAsList();
				...
				break;
			case 7: System.out.println("Enter the salary");
				salary = sc.nextFloat();
				List<Employee> listOfEmployees1 = es.findAllEmployeeAsListAsSalary(salary);
